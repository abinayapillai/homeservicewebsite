...
<tr><td><center><b>Work ID</b></center></td><td><center><b>Service Name</b></center></td><td><center><b>Service Details</b></center></td><td><center><b>Price</b></center></td><td><center><b>Available Timings</b></center></td></tr>
	...
	<tr> <td><center><%=temp.getWorkId()%> </center></td></td><td><center><%=temp.getServiceName()%></center></td><td><center><%=temp.getServiceDetails()%> </center></td><td><center><%=temp.getPrice()%> </center></td><td><center><%=temp.getAvailabelTimings()%> </center></td>
	</tr>
	<%} %>
</table>
</body>

  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="UserRegistration.jsp"><font color="white">New User Registration</font> </a></li>
        <li><a href="CustomerRegistration.jsp"><font color="white">New Customer Registration</font></a></li>
        <li><a href="AdminLogin.jsp"><font color="white">Admin Login</font></a></li>
         <li><a href="UserLogin.jsp"><font color="white">User Login</font></a></li>
          <li><a href="CustomerLogin.jsp"><font color="white">Customer Login</font></a></li>
      </ul><br>
      </body>
    </div>

...
<tr><td><br/>Enter Service Details: <font color="black"><input type="text" name="tf2" /></font></td>
</tr>
<tr><td><br/> Enter Price: <font color="black"><input type="number" name="tf3" /></font></td></tr>
<tr><td><br/> Enter Timing: <font color="black"><input type="text" name="tf4" /></font></td></tr>
<tr><td><br/> <input  type="submit" value="ADD SERVICE" class="btn btn-info" /></td>
</tr>
</table>
</form>

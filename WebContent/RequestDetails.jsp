...
<table class="table">
<tr><td><center><b>Request_Id</b></center></td><td><center><b>Worker Alloted</b></center></td><td><center><b>Time</b></center></td><td><center><b>Address</b></center></td></tr>
	<% for( Request temp: RequestList) { %>
	<tr> <td><center><%=temp.getRequest_Id() %> </center></td> <td><center><%=temp.getWorker() %> </center></td> <td><center><%=temp.getTime() %> </center></td> <td><center><%=temp.getAddress() %> </center></td></tr>
